...
class MarkerApp(ctk.CTk):
    ...
    def _build_ui(self) -> None:
        ...
        self.content_navigation_frame=ctk.CTkFrame(self,fg_color=("gray90","gray18"),corner_radius=8); self.content_navigation_frame.grid(row=1,column=0,padx=20,pady=(6,0),sticky="w")
        group_font=ctk.CTkFont(size=13,weight="bold")
        media_group=ctk.CTkFrame(self.content_navigation_frame,fg_color="transparent"); media_group.grid(row=0,column=0,padx=(8,6),pady=(3,4),sticky="w")
        ...
        ctk.CTkFrame(self.content_navigation_frame,width=1,fg_color=("gray72","gray35")).grid(row=0,column=1,padx=4,pady=5,sticky="ns")
        documents_group=ctk.CTkFrame(self.content_navigation_frame,fg_color="transparent"); documents_group.grid(row=0,column=2,padx=(6,8),pady=(3,4),sticky="w")
