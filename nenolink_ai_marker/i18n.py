...
DEFAULT_ENGLISH = {
    ...
    "update.automatic": "Automatically check for updates", "update.check": "Check for updates",
    "update.checking": "Checking for updates…", "update.available": "New version available: {version}",
    "update.error": "Could not check for updates. Please try again later.", "update.title": "Updates",
    "update.current": "You are using the current version: {version}",
    "update.privacy": "When enabled, AI Marker contacts nenolink.com at most once every 30 days solely to obtain release information. No media or user content is sent.",
    "shortcut.create": "Create Desktop Shortcut", "shortcut.title": "Desktop shortcut",
    "shortcut.success": "Desktop shortcut created.", "shortcut.error": "The desktop shortcut could not be created.",
    "shortcut.offer_title": "Create a desktop shortcut?", "shortcut.offer_message": "Would you like to create a Nenolink AI Marker shortcut on your desktop for easier access?",
    ...
    "pptx.selected": "PowerPoint selected: {name}", "pptx.scope": "Apply to slides",
    "pptx.scope.single": "One slide", "pptx.scope.selected": "Selected slides",
    "pptx.scope.range": "Slide range", "pptx.scope.all": "All slides",
    "pptx.slide": "Slide number", "pptx.selected_hint": "Slide numbers (comma-separated)",
    "pptx.from": "From", "pptx.to": "To", "pptx.output_language": "Disclosure language",
    "pptx.metadata_note": "AI Marker metadata is written to the new presentation. The source is never changed.",
    "pptx.process": "Save marked PowerPoint…", "pptx.choose_first": "Choose a PowerPoint file first.",
    "pptx.save_as": "Save marked PowerPoint as", "pptx.extension_error": "The output must be a .pptx file.",
    "pptx.error": "PowerPoint could not be processed: {error}",
    "pptx.saved": "PowerPoint saved: {name} ({count} slide(s) marked).", "pptx.preview_hint": "Choose a PowerPoint file to preview a slide.", "pptx.preview_unavailable": "Slide preview is unavailable.", "pptx.slide_status": "Slide {current} / {count}",
    "document.summary.slides": "{size} · {count} slides", "document.warning_title": "Large document",
    "document.limit_title": "Document limit exceeded", "document.pptx_warning": "This PowerPoint is above the recommended size of 100 MB or 150 slides. Processing may require more time and memory. Continue?",
    "document.pptx_hard": "This PowerPoint exceeds the hard limit of 300 MB or 500 slides and cannot be processed.",
    "document.summary.pages": "{size} · {count} pages", "document.pdf_warning": "This PDF is above the recommended size of 100 MB or 300 pages. Processing may require more time and memory. Continue?", "document.pdf_hard": "This PDF exceeds the hard limit of 300 MB or 1,000 pages and cannot be processed.",
    "pdf.choose": "Choose PDF file", "pdf.no_file": "No PDF selected", "pdf.selected": "PDF selected: {name}", "pdf.page": "Page number", "pdf.selected_hint": "Page numbers (comma-separated)", "pdf.metadata_note": "AI Marker disclosure metadata is written to the new PDF. It is a disclosure statement, not proof of authorship or AI provenance.", "pdf.add_badge": "Add AI badge", "pdf.overlay_required": "Enable an AI badge, Own Logo, or both.", "pdf.process": "Save marked PDF…", "pdf.scope": "Apply to pages", "pdf.scope.single": "One page", "pdf.scope.selected": "Selected pages", "pdf.scope.range": "Page range", "pdf.scope.all": "All pages", "pdf.preview_hint": "Choose a PDF to preview one page.", "pdf.preview_unavailable": "Page preview is unavailable.", "pdf.page_status": "Page {current} / {count}", "pdf.encrypted": "Encrypted or password-protected PDFs are not supported.", "pdf.error": "PDF could not be processed: {error}", "pdf.choose_first": "Choose a PDF first.", "pdf.save_as": "Save marked PDF as", "pdf.extension_error": "The output must be a .pdf file.", "pdf.saved": "PDF saved: {name} ({count} page(s) marked).", "pdf.signature_title": "Digital signature warning", "pdf.signature_warning": "This PDF appears to contain a digital signature. Modifying it may invalidate the existing signature. Continue?",
    ...
    "badge.no_ai_disclaimer": "No AI is a user-selected declaration. Nenolink AI Marker does not verify that content was created without the use of AI.",
